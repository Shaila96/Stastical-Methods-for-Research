...
colnames(FreeThrowAttempt) <- Seasons
FreeThrowAttempt



#Remove unnecessary vector data
rm(KobeBryant_FT,
   JoeJohnson_FT,
   LeBronJames_FT,
   CarmeloAnthony_FT,
...
plot_matrix(FreeThrowAttempt/Games)


#-------------- Task2
# Accuracy of Free Throws
plot_matrix(FreeThrow/FreeThrowAttempt)

#-------------- Task3
# Player playing style (2 vs 3 points preference) excluding Free Throws*
plot_matrix((Points-FreeThrow)/FieldGoals)
