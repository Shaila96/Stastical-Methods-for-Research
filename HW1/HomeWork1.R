...
par(mar=graph_size_vector, mgp = c(3, 1, 0))
...
par(mar=graph_size_vector, mgp = c(7, 1, 0), new=TRUE)
plot(x=criminal_justice_df$POP,
     ...
     yaxt="n")
axis(4)
mtext("Per Capita Expenditures",side=4,line=3)
# mtext("Per Capita Expend",side=1,line=3)
legend("topleft",col=c("red","blue"),lty=1,legend=c("Total Expend","Per Capita Expend"))
...
bar_plot <- ggplot(down_syndrome_df, 
                   aes(x=Age.Group..Years, 
                       ...
                       color=Total.Number.of.Births,
                       fill=Total.Number.of.Births))
...
bar_plot <- ggplot(down_syndrome_df, 
                   aes(x=Age.Group..Years, 
                       ...
                       color=Number.of.Mothers.of.Down.Syndrome.Patients,
                       fill=Number.of.Mothers.of.Down.Syndrome.Patients))
bar_plot + geom_bar(stat="identity")
